...
!-------------------------------------------------------
      ...
      node_xyz(1,:)=node_xyz(1,:)*sclf2+rext1*xpos2
      node_xyz(2,:)=node_xyz(2,:)*sclf2+rext2/2.d0
      node_xyz(3,:)=node_xyz(3,:)*sclf2+sclf2/2.d0 !alx3/4.d0
      ...
      do kc=kstartr,kendr
        do jc=1,n2r
          do ic=1,n1r
            ...
            if(inside) then
              isbody2(ic,jc,kc) = 1.d0
            else
              isbody2(ic,jc,kc) = 0.d0
            endif
          enddo
        enddo
      enddo
      ...
      if(myid.eq.0) write(*,*)'  Sum isbody2: ',buf
